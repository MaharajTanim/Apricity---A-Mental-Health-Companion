...
const EditNoteModal = ({ isOpen, onClose, onSuccess, diary }) => {
  ...
  // Populate form when modal opens or diary changes
  useEffect(() => {
    if (isOpen && diary) {
      setFormData({
        title: diary.title || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // PUT to /api/diary/:id with Authorization header (automatically added by api.js)
      const response = await api.put(`/api/diary/${diary.id}`, {
